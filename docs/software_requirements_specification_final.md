...
| TC16 | Tests if the player returns to the first level when their health reaches 0 | Collide with an enemy or enemy projectile until currentHealth == 0 | Use movement keys to collide with an enemy 15 times | currentHealth == 0 Player returns to the start of the first scene | currentHealth == 0 Player returns to the start of the first scene | Pass | FR3, FR6, NFR13 |
## System Tests
| ID | Description | Steps | Input Values | Expected Output | Actual Output | Pass/Fail | Requirement Link |
| :-: | :-: | :-: | :-: | :-: | :-: | :-: | :-: |
